<template>
  <div class="commodity">
    ...
    <div class="operate">
      ...
      <!-- <div class="right-op">
        <div>
          <el-button  @click="batchEnable" type="success" data-code="10030004"  icon="iconfont icon-icon_up">启用</el-button>&nbsp;&nbsp;&nbsp;
          <el-button @click="batchDisable" type="danger" data-code="10030005"  icon="iconfont icon-icon_down">停用</el-button>
        </div>
      </div> -->
    </div>
    </div>
    ...
    :visible.sync="showAddStaff"
      ...
      :before-close="handleClose" class="import-dialog">
        ...
        <add-staff  @refresh="refresh" @cancel="cancel" ref="clean"></add-staff>
    </el-dialog>
    <el-dialog
    :visible.sync="showEditStaff"
      ...
      :before-close="handleClose2" class="import-dialog">
        <div slot="title" class="left-title">
          ...
          <add-staff :staffID="staffId" @refresh="refresh" @cancel="cancel" :type="change"></add-staff>
    </el-dialog>
  </div>
</template>
<script>
...
import addStaff from '../../../components/store/addStaff1'
