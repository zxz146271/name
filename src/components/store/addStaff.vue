            ...
            <el-row :gutter="24">
              ...
              <el-col :span="24">
                <el-form-item label="角色" prop="roleCodes">
                  <el-checkbox-group v-model="staff.roleCodes" @change="chang">
                    <el-row :gutter="24">
              ...
              <el-col :span="24" >
                <el-form-item label="门店" v-if="flag2" prop="storeId">
  ...
  data () {
    return {
      ...
      rules: {
        ...
        storeId: [
          { required: true, message: '请选择员工门店', trigger: 'change' }
        ],
        weChat: [
  ...
  methods: {
    ...
    initData () {
      ...
      this.$api.stStaffgetDetailById(params).then(res => {
        this.staff = res.data
        if (res.data.distributorId === res.data.storeId) {
          this.staff.storeId = null
        }
        if (!this.staff.storeId) {
          this.flag2 = false
        } else {
          this.flag2 = true
        }
