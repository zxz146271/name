            ...
            <el-row :gutter="24">
              <el-col :span="24" v-if='showModle'>
                <el-form-item label="门店" prop="defaultRoleId" >
                  <el-input v-model="money.storeName"  :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="24" v-else>
                <el-form-item label="员工" prop="defaultRoleId" >
                  <el-input v-model="money.staffName"  :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="24" v-if="money.month">
              ...
              <el-col :span="24">
                <el-form-item label="期望营业额" prop="expectationMoney">
                  <el-input v-model="ruleForm.expectationMoney"></el-input>
                </el-form-item>
              </el-col>
              <!-- <el-col :span="24">
                <el-form-item label="实际营业额" prop="number">
                  <el-input v-model="ruleForm.actualMoney"  :disabled="true"></el-input>
                </el-form-item>
              </el-col> -->
            </el-row>
          </el-form>
...
export default {
  ...
  methods: {
    ...
    submit (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.performanceVo.expectationMoney = this.ruleForm.expectationMoney
          ...
          this.$api.editSaveMoney(params).then(res => {
            if (res.code === 0) {
              this.loading = false
              this.$emit('refresh')
            } else {
    ...
    initData () {
      let params = {
        performanceId: this.money.performanceId
      }
      this.$api.getmoneyperfById(params).then(res => {
