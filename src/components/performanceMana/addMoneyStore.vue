             ...
             <el-col :span="24" v-show="ruleForm.type">
              ...
              <el-col :span="24" >
                <el-form-item label="老板的目标业绩" >
                  <el-input v-model="ruleForm.expectationMoney" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
...
export default {
  ...
  methods: {
    ...
    changeWeek (value) {
      this.ruleForm.expectationMoney = this.weekData[value].expectationMoney
      this.ruleForm.week = this.weekData[value].week
    },
    changeMonth (value) {
      this.ruleForm.expectationMoney = this.monthData[value].expectationMoney
      this.ruleForm.month = this.monthData[value].month
    },
    changeType (value) {
      // this.ruleForm.expectationMoney = 0
      this.ruleForm.month = ''
      this.ruleForm.week = ''
      if (value === '1') {
        this.flag = false
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (this.flag5) {
            ...
            if (count < this.ruleForm.expectationMoney) {
