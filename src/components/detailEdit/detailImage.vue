<template>
<div class="caseimgbox" @click="showEdit">
   <div class="casesimg">
      <!-- https://www.muyusi.com/website-static/images/image03.jpg -->
         <img :src="imageUrl" alt="" :style="'border-radius:'+block.content.radius+'px'">
   </div>
  ...
  <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        ...
        <el-row class="light">
            <el-col :span="12"><div class="grid-content bg-purple">取消</div></el-col>
...
export default {
  ...
  mounted () {
    this.imageUrl = this.block.content.image
  ...
  watch: {
    block: {
      handler (newV, oldV) {
        console.log(newV)
        console.log(oldV)
        this.imageUrl = newV.content.image
      },
      deep: true
    }
  },
