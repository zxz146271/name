  ...
  <div class="activity-box">
    ...
    <div class="box" v-if="data[0] && data[0].type =='0'">
      <el-table :data="data" :show-header="false" align="center">
        <!-- 优惠券单选框 -->
        <el-table-column align="center" label="优惠券单选框">
          <template slot-scope="scope">
            <el-radio @change.native="getCurrentRow(scope.$index)" :label="scope.$index" v-model="radio" class="textRadio">&nbsp;</el-radio>
          </template>
        </el-table-column>
        <!-- 优惠券单选框结束 -->
        <el-table-column label="Name" prop="couponName" width="150" align="left"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
        //单选
      getCurrentRow(row) {
        this.$emit('childByValue', this.data[row])
      },
      checkChange(){
