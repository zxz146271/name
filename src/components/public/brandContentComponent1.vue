<template>
    <div class="storeContentBox">
        <byTypeQuery @changeContentType = "changeContentType" :radio="radio" />
        <div v-if="contentData.length !== 0">
            ...
            <div class="dialog-footer">
                <el-button @click="clickCancel1">取 消</el-button>
                <el-button type="primary" @click="clickSubmit1">提 交</el-button>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        // 取消
        clickCancel1 () {
            this.$emit("clickCancel1")
        },
        // 提交
        clickSubmit1 () {
            this.$emit("clickSubmit1",this.item)
        }
    }
}
</script>
